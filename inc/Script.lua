...
local function iturbo(msg,MsgText)
...
if redis:get(turbo..'lock_id'..msg.chat_id_) then
local msgs = redis:get(turbo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local GroupName = (redis:get(turbo..'group:name'..msg.chat_id_) or '')
redis:set(turbo..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
if not msg.Director and redis:get(turbo..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(turbo..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(turbo..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(turbo..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(turbo..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(turbo..'linkGroup'..msg.chat_id_) then 
return "📡*¦* اوه 🙀 لا يوجد رابط ☹️\n🔖*¦*لانشاء رابط ارسل { انشاء رابط } \n📡" 
end
local GroupName = redis:get(turbo..'group:name'..msg.chat_id_)
local GroupLink = redis:get(turbo..'linkGroup'..msg.chat_id_)
...
local Text = "🔖¦رابـط الـمـجـمـوعه 💯\n🌿¦ "..Flter_Markdown(redis:get(turbo..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(turbo..'flood'..msg.chat_id_,MsgText[2]) 
...
local Admins = redis:scard(turbo..'admins:'..msg.chat_id_)
if Admins ==0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ادمنيه ليتم مسحهم ✓" 
end
redis:del(turbo..'admins:'..msg.chat_id_)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local Mn3Word = redis:scard(turbo..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*¦* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(turbo..':Filter_Word:'..msg.chat_id_)
...
redis:del(turbo..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(turbo..'welcome:msg'..msg.chat_id_) then 
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(turbo..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(turbo..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "📛¦ عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(turbo..':MONSHA_BOT:'..msg.chat_id_)
...
local NumMDER = redis:scard(turbo..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "📛¦ عذرا لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(turbo..'owners:'..msg.chat_id_)
...
local list = redis:smembers(turbo..'banned:'..msg.chat_id_)
if #list == 0 then return "*📌¦ لا يوجد مستخدمين محظورين  *" end
message = '📋*¦* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(turbo..'banned:'..msg.chat_id_)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local MKTOMEN = redis:scard(turbo..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*¦* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(turbo..'is_silent_users:'..msg.chat_id_)
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MKTOMEN.." *} من المكتومين  \n✓"
end

if MsgText[2] == 'المميزين' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local MMEZEN = redis:scard(turbo..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*⚙️*¦ لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(turbo..'whitelist:'..msg.chat_id_)
...
redis:del(turbo..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(turbo..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(turbo..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(turbo..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(turbo..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(turbo..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(turbo..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(turbo..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(turbo..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(turbo..'CheckExpire::'..msg.chat_id_) then 
redis:set(turbo..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️¦ في مجموعه  » »  '..redis:get(turbo..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if MsgText[2] == '1' then
redis:setex(turbo..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(turbo..'CheckExpire::'..msg.chat_id_) then 
redis:set(turbo..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم تفعيل الاشتراك   👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم تفعيل الاشتراك  👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(turbo..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(turbo..'CheckExpire::'..msg.chat_id_) then 
redis:set(turbo..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(turbo..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(turbo..'CheckExpire::'..msg.chat_id_) then 
redis:set(turbo..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
local check_time = redis:ttl(turbo..'ExpireDate:'..msg.chat_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(turbo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(turbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(turbo..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(turbo..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(turbo..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(turbo..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(turbo..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(turbo..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(turbo..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
return '🧟‍♂*¦*  عدد جهہآتگ آلمـضـآفهہ‏‏ » 【'..(redis:get(turbo..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 . \n🐾'
end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:set(turbo..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if redis:get(turbo..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(turbo..'welcome:msg'..msg.chat_id_))
else 
return "🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."  \n🌿¦ نورت المجموعه \n💂🏼‍♀️" 
end 
end
...
redis:setex(turbo..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(turbo..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(turbo..':NameBot:')..[[ 🎖
...
redis:setex(turbo..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭¦ حسننا عزيزي 🍁\n💬¦ الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(turbo..':addnumberusers',MsgText[2]) 
return '💱*¦* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*¦* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(turbo..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🔝" then 
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
return '📮*¦* عدد المجموعات المفعلة » `'..redis:scard(turbo..'group:ids')..'`  ➼' 
end
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if redis:sismember(turbo..'group:ids',MsgText[2]) then
local name_gp = redis:get(turbo..'group:name'..MsgText[2])
...
return redis:get(turbo..":TEXT_SUDO") or '🗃¦ لا توجد كليشه المطور .\n📰¦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(turbo..'lock_brod') then 
return "📡*¦* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(turbo..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(turbo..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(turbo..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(turbo..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(turbo..'welcom:witting'..msg.sender_user_id_,
turbo..'rulse:witting'..msg.sender_user_id_,
turbo..'rulse:witting'..msg.sender_user_id_,
turbo..'name:witting'..msg.sender_user_id_,
turbo..'about:witting'..msg.sender_user_id_,
turbo..'fwd:all'..msg.sender_user_id_,
turbo..'fwd:pv'..msg.sender_user_id_,
turbo..'fwd:groups'..msg.sender_user_id_,
turbo..'namebot:witting'..msg.sender_user_id_,
turbo..'addrd_all:'..msg.sender_user_id_,
turbo..'delrd:'..msg.sender_user_id_,
turbo..'addrd:'..msg.sender_user_id_,
turbo..'delrdall:'..msg.sender_user_id_,
turbo..'text_sudo:witting'..msg.sender_user_id_,
turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_,
turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://MAXTAME.github.io/GetVersion.txt') or 0
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*¦* يوجد تحديث جديد الان \n📡*¦* جاري تنزيل وتثبيت التحديث  ...')
redis:set(turbo..":VERSION",GetVerison)
return false
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الـزعـيـم 🍃",url="t.me/MAXTAME"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : الـزعـيـم](t.me/MAXTAME)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 📈" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
return 'الاحصائيات : 📈 \n\n👥*¦* عدد المجموعات المفعله : '..redis:scard(turbo..'group:ids')..'\n👤*¦* عدد المشتركين في البوت : '..redis:scard(turbo..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(turbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "📭¦ حسننا الان ارسل كلمة الرد العام 🍃\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local names 	= redis:exists(turbo..'replay:'..msg.chat_id_)
local photo 	= redis:exists(turbo..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(turbo..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(turbo..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(turbo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(turbo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(turbo..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(turbo..'replay:'..msg.chat_id_,turbo..'replay_photo:group:'..msg.chat_id_,turbo..'replay_voice:group:'..msg.chat_id_,
turbo..'replay_animation:group:'..msg.chat_id_,turbo..'replay_audio:group:'..msg.chat_id_,turbo..'replay_sticker:group:'..msg.chat_id_,turbo..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(turbo..'replay:all')
local photo 	= redis:exists(turbo..'replay_photo:group:')
local voice 	= redis:exists(turbo..'replay_voice:group:')
local imation 	= redis:exists(turbo..'replay_animation:group:')
local audio 	= redis:exists(turbo..'replay_audio:group:')
local sticker 	= redis:exists(turbo..'replay_sticker:group:')
local video 	= redis:exists(turbo..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(turbo..'replay:all',turbo..'replay_photo:group:',turbo..'replay_voice:group:',turbo..'replay_animation:group:',turbo..'replay_audio:group:',turbo..'replay_sticker:group:',turbo..'replay_video:group:')
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:set(turbo..'delrdall:'..msg.sender_user_id_,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:set(turbo..'delrd:'..msg.sender_user_id_,true)
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرد لمسحها من  للمجموعه 🍃"
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local names  	= redis:hkeys(turbo..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(turbo..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(turbo..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(turbo..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(turbo..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(turbo..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(turbo..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(turbo..'replay:all')
local photo 	= redis:hkeys(turbo..'replay_photo:group:')
local voice 	= redis:hkeys(turbo..'replay_voice:group:')
local imation 	= redis:hkeys(turbo..'replay_animation:group:')
local audio 	= redis:hkeys(turbo..'replay_audio:group:')
local sticker 	= redis:hkeys(turbo..'replay_sticker:group:')
local video 	= redis:hkeys(turbo..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*¦* لا يوجد ردود مضافه حاليا \n❕' 
end
local ii = 1
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:setex(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(turbo..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭¦ حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(turbo..'namebot:witting'..msg.sender_user_id_,300,true)
...
`git clone https://github.com/MAXTAME/turbo.git ;cd turbo;chmod +x ins;./ins`
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://MAXTAME.github.io/GetFiles.json")
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/MAXTAME/MAXTAME.github.io/master/plugins/"..FileName)
if res == 200 then
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
if redis:get(turbo..":UserNameChaneel") then
return "📑| اهلا عزيزي المطور \n🔖| الاشتراك بالتأكيد مفعل"
else
redis:setex(turbo..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local SubDel = redis:del(turbo..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local UserChaneel = redis:get(turbo..":UserNameChaneel")
if UserChaneel then
...
local function dturbo(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(turbo..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(turbo..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛¦* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(turbo..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(turbo..'users',msg.sender_user_id_)
if redis:get(turbo..'lock_service') then 
text = [[💯¦ مـرحبآ آنآ بوت آسـمـي []]..redis:get(turbo..':NameBot:')..[[] 🎖
💰¦ آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
...
local MSG_ID = (redis:get(turbo.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(turbo..'lock_twasel') then
...
redis:setex(turbo.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group =====================================
if redis:get(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(turbo..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(turbo..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(turbo..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد 🚀 \n-')
elseif msg.photo then 
redis:hset(turbo..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.voice then
redis:hset(turbo..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.animation then
redis:hset(turbo..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.video then
redis:hset(turbo..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.audio then
redis:hset(turbo..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.sticker then
redis:hset(turbo..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(turbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(turbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(turbo..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد لكل المجموعات 🚀 ')
elseif msg.photo then 
redis:hset(turbo..'replay_photo:group:',klma,photo_id)
redis:del(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.voice then
redis:hset(turbo..'replay_voice:group:',klma,voice_id)
redis:del(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.animation then
redis:hset(turbo..'replay_animation:group:',klma,animation_id)
redis:del(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.video then
redis:hset(turbo..'replay_video:group:',klma,video_id)
redis:del(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.audio then
redis:hset(turbo..'replay_audio:group:',klma,audio_id)
redis:del(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.sticker then
redis:hset(turbo..'replay_sticker:group:',klma,sticker_id)
redis:del(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(turbo..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(turbo..":ForceSub:"..msg.sender_user_id_)
...
redis:set(turbo..":UserNameChaneel",msg.text)
...
if redis:get(turbo..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(turbo..'namebot:witting'..msg.sender_user_id_)
redis:set(turbo..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭¦ تم تغير اسم البوت  ✋🏿\n🗯¦ الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(turbo..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(turbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(turbo..'replay_photo:group:',msg.text)
redis:hdel(turbo..'replay_voice:group:',msg.text)
redis:hdel(turbo..'replay_animation:group:',msg.text)
redis:hdel(turbo..'replay_audio:group:',msg.text)
redis:hdel(turbo..'replay_sticker:group:',msg.text)
redis:hdel(turbo..'replay_video:group:',msg.text)
redis:setex(turbo..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n-")
end
end

if redis:get(turbo..'delrdall:'..msg.sender_user_id_) then
redis:del(turbo..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(turbo..'replay:all',msg.text)
local photo =redis:hget(turbo..'replay_photo:group:',msg.text)
local voice = redis:hget(turbo..'replay_voice:group:',msg.text)
local animation = redis:hget(turbo..'replay_animation:group:',msg.text)
local audio = redis:hget(turbo..'replay_audio:group:',msg.text)
local sticker = redis:hget(turbo..'replay_sticker:group:',msg.text)
local video = redis:hget(turbo..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*¦* هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(turbo..'replay:all',msg.text)
redis:hdel(turbo..'replay_photo:group:',msg.text)
redis:hdel(turbo..'replay_voice:group:',msg.text)
redis:hdel(turbo..'replay_audio:group:',msg.text)
redis:hdel(turbo..'replay_animation:group:',msg.text)
...
if redis:get(turbo..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(turbo..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(turbo..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*¦* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(turbo..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(turbo..'welcom:witting'..msg.sender_user_id_) 
redis:set(turbo..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*¦* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(turbo..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(turbo..'rulse:witting'..msg.sender_user_id_) 
redis:set(turbo..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*¦* مرحبآ عزيزي\n📦¦ تم حفظ القوانين بنجاح ✓\n🔖¦ ارسل [[ القوانين ]] لعرضها \n💬✓')
end
if redis:get(turbo..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(turbo..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(turbo..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(turbo..'about:witting'..msg.sender_user_id_) 
...
if redis:get(turbo..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(turbo..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(turbo..'users')  
local groups = redis:smembers(turbo..'group:ids')
...
if redis:get(turbo..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(turbo..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(turbo..'users')
if #pv >= 300 then
...
if redis:get(turbo..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(turbo..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(turbo..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(turbo..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(turbo..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(turbo..':NameBot:')..[[ 🎖
💰¦ آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
⚖️¦ مـعرف آلمـطـور  : ]]..SUDO_USER:gsub([[\_]],'_')..[[ 🌿
👨🏽‍🔧]])
...
if msg.forward_info and redis:get(turbo..'fwd:'..msg.sender_user_id_) then
redis:del(turbo..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(turbo..'users')
local groups = redis:smembers(turbo..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.photo and redis:get(turbo..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(turbo..'welcom_ph:witting'..msg.sender_user_id_)
redis:set(turbo..':WELCOME_BOT',photo_id)
sendMsg(msg.chat_id_,msg.id_,'🚸 ¦ تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
return false
end 

if msg.photo and msg.type == "channel" and msg.GroupActive then
if redis:get(turbo..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(turbo..'photo:group'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(turbo..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(turbo..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(turbo..'replay:'..msg.chat_id_,msg.text)
redis:hdel(turbo..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(turbo..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(turbo..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(turbo..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(turbo..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(turbo..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(turbo..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جواب الرد \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n-")
end
end

if redis:get(turbo..'delrd:'..msg.sender_user_id_) then
redis:del(turbo..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(turbo..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(turbo..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(turbo..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(turbo..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(turbo..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(turbo..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(turbo..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*¦* هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(turbo..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(turbo..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(turbo..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(turbo..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
if redis:get(turbo..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(turbo..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
if welcome then
rules = (redis:get(turbo..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(turbo..'group:name'..msg.chat_id_) or '')))
...
--------------------------------------------
if msg.adduser and redis:get(turbo..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(turbo..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(turbo..'welcome:get'..msg.chat_id_)
end
redis:setex(turbo..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(turbo..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(turbo..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(turbo..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(turbo..'sender:'..msg.sender_user_id_..':flood',30,true)
...
redis:setex(turbo..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
 
 
if msg.forward_info_ then
if redis:get(turbo..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(turbo..'lock_woring'..msg.chat_id_) and not redis:get(turbo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(turbo..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(turbo..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(turbo..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*¦* لا يمكنني مسح الرساله المخالفه .\n🎟*¦* لست مشرف او ليس لدي صلاحيه  الحذف \n ❕')    
end
if redis:get(turbo..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(turbo..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(turbo..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(turbo..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(turbo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(turbo..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(turbo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(turbo..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(turbo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(turbo..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(turbo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(turbo..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(turbo..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(turbo..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(turbo..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(turbo..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(turbo..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(turbo..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(turbo..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(turbo..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(turbo..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(turbo..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(turbo..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(turbo..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(turbo..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(turbo..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(turbo..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(turbo..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(turbo..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(turbo..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(turbo..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(turbo..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(turbo..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(turbo..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(turbo..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(turbo..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(turbo..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(turbo..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(turbo..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(turbo..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(turbo..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(turbo..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
if redis:get(turbo..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(turbo..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️¦ انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧¦ المجموعه : '..FlterName(redis:get(turbo..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️¦ ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🕵🏼️‍♀️¦ انتهى الاشتراك البوت✋🏿\n💂🏻‍♀️¦ سوف اغادر المجموعه فرصه سعيده 👋🏿\n👨🏾‍🔧¦ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
return StatusLeft(msg.chat_id_,our_id)
else
local DaysEx = (redis:ttl(turbo..'ExpireDate:'..msg.chat_id_) / 86400)
